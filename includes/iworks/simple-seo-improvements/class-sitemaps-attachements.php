<?php
/**
 * Sitemaps: iworks_simple_seo_improvements_sitemaps_attachements class
 *
 ...
 * @since 5.5.0
 */
class iworks_simple_seo_improvements_sitemaps_attachements extends WP_Sitemaps_Provider {
	/**
	 * iworks_simple_seo_improvements_sitemaps_attachements constructor.
	 *
	 * @since 5.5.0
	 */
