...
require_once( dirname( __DIR__ ) . '/class-simple-seo-improvements-base.php' );

class iworks_simple_seo_improvements_github extends iworks_simple_seo_improvements_base {

	private string $repository = 'iworks/simple-seo-improvements';
	private string $basename   = 'simple-seo-improvements';
	...
	public function action_init_load_plugin_textdomain() {
		$dir = plugin_basename( $this->dir ) . '/languages';
		load_plugin_textdomain( 'simple-seo-improvements', false, $dir );
	}
