...
function iworks_simple_seo_improvements_options() {
	...
	$options['index'] = array(
		...
		'options'         => array(
			...
			array(
				'type'  => 'heading',
				'label' => __( 'AI', 'simple-seo-improvements' ),
				'since' => '2.0.2',
			),
			array(
				'name'              => 'ai_block_apple',
				'type'              => 'checkbox',
				'th'                => __( 'Apple', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
			...
			array(
				'name'              => 'ai_block_anthropic',
				'type'              => 'checkbox',
				'th'                => __( 'Anthropic', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
			...
			array(
				'name'              => 'ai_block_bytespider',
				'type'              => 'checkbox',
				'th'                => __( 'Bytespider', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
			...
			array(
				'name'              => 'ai_block_claude',
				'type'              => 'checkbox',
				'th'                => __( 'Claude', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
			...
			array(
				'name'              => 'ai_block_cohere',
				'type'              => 'checkbox',
				'th'                => __( 'Cohere', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
			...
			array(
				'name'              => 'ai_block_diffbot',
				'type'              => 'checkbox',
				'th'                => __( 'Diffbot', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
			...
			array(
				'name'              => 'ai_block_facebook',
				'type'              => 'checkbox',
				'th'                => __( 'Facebook', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
			...
			array(
				'name'              => 'ai_block_gptbot',
				'type'              => 'checkbox',
				'th'                => __( 'GPT Bot', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
			...
			array(
				'name'              => 'ai_block_oai',
				'type'              => 'checkbox',
				'th'                => __( 'OAI Search Bot', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
			...
			array(
				'name'              => 'ai_block_perplexity',
				'type'              => 'checkbox',
				'th'                => __( 'Perplexity Bot', 'simple-seo-improvements' ),
				'default'           => 0,
				'sanitize_callback' => 'absint',
				'classes'           => array( 'switch-button' ),
				'since'             => '2.3.3',
